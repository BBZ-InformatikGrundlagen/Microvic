...
int main() {
    ...
    while (1) {
        ...
        while (winner) {
            ...
            //Wenn beide Spieler fünf Punkte haben, wird "DRAW!" angezeigt.
            if (scoreplayer1 + scoreplayer2 == 4){
                uBit.display.scroll("DRAW!");

                //Buzzer ertönt für 10 Sekunden
                buzzer.setAnalogValue(512);
                uBit.sleep(1000);
                buzzer.setAnalogValue(0);
            }

            //Wenn Spieler 1 fünf Punkte erreicht hat, wird "PLAYER 1 WINS! angezeigt
            ...
            //Wenn Spieler 2 fünf Punkte erreicht hat, wird "PLAYER 1 WINS! angezeigt
